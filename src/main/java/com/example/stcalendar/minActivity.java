...
public class minActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (saver.getMin() != null) {
            startMinTxt.setText(saver.getMin());
        }else{
        ...
        minBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(minActivity.this, hourActivity.class);
        ...
        minForward.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(minActivity.this, endYearActivity.class);
                startActivity(intent);
            }
        });
