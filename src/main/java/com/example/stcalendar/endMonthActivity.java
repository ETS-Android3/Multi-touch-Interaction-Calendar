...
public class endMonthActivity extends AppCompatActivity implements View.OnClickListener {
    private TextView endMonthTxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.end_month_layout);

        endMonthTxt = findViewById(R.id.endMonthTxt);
        if(saver.endGetMonth()!=null) {
            endMonthTxt.setText(saver.endGetMonth());
        }
        ...
        monthForward.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(endMonthActivity.this,endDateActivity.class);
        ...
        monthBack.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                Intent intent = new Intent(endMonthActivity.this,endYearActivity.class);
                startActivity(intent);
            }
        });
    }
