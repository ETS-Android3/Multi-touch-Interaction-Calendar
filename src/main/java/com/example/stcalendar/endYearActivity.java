...
public class endYearActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.end_year_layout);yearForward = (ImageButton) findViewById(R.id.endYearForward);
        ...
        if(saver.endGetYear()!=null){
            startYearTxt.setText(saver.endGetYear());
        }
        ...
        yearForward.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                if(startYearTxt.getText().length()==4) {
                    Intent intent = new Intent(endYearActivity.this, endMonthActivity.class);
        ...
        yearBack.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                Intent intent = new Intent(endYearActivity.this,minActivity.class);
                startActivity(intent);
            }
        });
    }
    ...
    public void yearChanger(Button b){
        ...
        saver.endSetYear(Integer.parseInt(partOneYr));
    }
    ...
    public void increment(){
        ...
        saver.endSetYear(Integer.parseInt(currentYrStr));
    }
