...
public class endHourActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.end_hour_layout);
        ...
        if(saver.endGetHour()!=null){
            selectedHour = saver.endGetHour();
        }
        if(saver.endGetPeriod()!=null){
            period = " " + saver.endGetPeriod();
        }
        ...
        hourForward.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(endHourActivity.this,endMinActivity.class);
        ...
        hourBack.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                Intent intent = new Intent(endHourActivity.this,endDateActivity.class);
                startActivity(intent);
            }
        });
    }
