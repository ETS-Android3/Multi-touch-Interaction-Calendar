...
public class dateActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(saver.getDateStr()!=null){
            startDateTxt.setText(saver.getDateStr());
        }else{
            startDateTxt.setText(date);
        }
        ...
        dateBack.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(dateActivity.this,monthActivity.class);
    ...
    public void dateSetter(Button b){
        ...
        startDateTxt.setText(date);
        saver.setDate(Integer.parseInt(date));
    }
